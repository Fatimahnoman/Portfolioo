  ...
  return (
    <section className="relative bg-[#0a0a0f] py-20 sm:py-24 px-4 sm:px-6 md:px-12 lg:px-24 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-pink-500/[0.03] rounded-full blur-[150px]" />
      </div>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="relative min-h-[280px] sm:min-h-[260px]">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Top accent */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-[2px] bg-gradient-to-r from-transparent via-rose-500/40 to-transparent" />

              {/* Quote mark */}
              <div className="text-5xl sm:text-6xl text-transparent bg-clip-text bg-gradient-to-br from-rose-500/40 to-rose-500/20 mb-3 leading-none select-none">
                &ldquo;
              </div>
              ...
              <div className="flex items-center justify-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-rose-500/20 to-rose-500/20 border border-white/[0.08] flex items-center justify-center">
          ...
          {testimonials.map((_, index) => (
            <button
              ...
              className={`h-2 rounded-full transition-all duration-500 ${
                index === current
                  ? "bg-gradient-to-r from-rose-500 via-rose-500 to-pink-500 w-7"
