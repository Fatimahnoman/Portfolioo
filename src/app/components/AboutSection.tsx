        ...
        >
          ...
          >
            ...
            <div className="text-sm sm:text-base md:text-lg text-gray-400 leading-relaxed mb-4 sm:mb-6 space-y-4">
              ...
              <p>
                I started by falling in love with <span className="text-purple-400 font-medium">Python</span> — from writing my first OOP classes to architecting complex systems. That obsession naturally pulled me toward{" "}
                <span className="text-violet-400 font-medium">Agentic AI</span>, where I now build
