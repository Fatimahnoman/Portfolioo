...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="relative bg-[#0a0a0f] py-20 sm:py-24 px-4 sm:px-6 md:px-10 lg:px-24 text-white overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-48 h-48 sm:w-96 sm:h-96 bg-rose-500/5 rounded-full filter blur-3xl -z-10" />
      <div className="absolute bottom-0 left-0 w-48 h-48 sm:w-96 sm:h-96 bg-rose-500/5 rounded-full filter blur-3xl -z-10" />
        ...
        >
          ...
          >
            <div className="relative group">
              {/* Decorative border */}
              <div className="absolute -inset-1 bg-gradient-to-r from-rose-600 via-rose-500 to-pink-500 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200" />
              ...
              <Image
                ...
                className="relative rounded-2xl shadow-xl shadow-rose-500/10 w-full object-cover"
              />
              
              {/* Floating badge */}
              <motion.div 
                className="absolute -bottom-3 -right-3 sm:-bottom-4 sm:-right-4 bg-gradient-to-r from-rose-600 via-rose-500 to-pink-500 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg shadow-lg text-xs sm:text-sm"
          ...
          >
            <motion.h2 
              className="text-3xl sm:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-rose-400 via-rose-400 to-pink-400 mb-4 sm:mb-6"
            ...
            <div className="text-sm sm:text-base md:text-lg text-gray-400 leading-relaxed mb-4 sm:mb-6 space-y-4">
              <p>
                ...
                <span className="text-rose-400 font-medium">AI Developer</span> &{" "}
                <span className="text-rose-400 font-medium">Automation Specialist</span> who thrives
                at the intersection of code, intelligence, and real-world impact.
              </p>

              <p>
                I started by falling in love with <span className="text-rose-400 font-medium">Python</span> — from writing my first OOP classes to architecting complex systems. That obsession naturally pulled me toward{" "}
                <span className="text-pink-400 font-medium">Agentic AI</span>, where I now build
              ...
              <p>
                ...
                <span className="text-rose-400 font-medium">AI</span>,{" "}
                <span className="text-pink-400 font-medium">automation</span>, and{" "}
                <span className="text-blue-400 font-medium">strategic thinking</span>{" "}
                to build systems that don&apos;t just work — they{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 via-rose-400 to-pink-400 font-semibold">empower</span>.
              </p>
            </div>
