    ...
    <section className="relative bg-[#070512] py-24 sm:py-32 px-4 sm:px-6 md:px-12 lg:px-24 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          {/* Badge */}
          <motion.div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/[0.07] border border-violet-500/20 mb-8"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-12 max-w-2xl mx-auto">
            {[
              ...
              <motion.div
                ...
                className="bg-white/[0.03] border border-white/[0.08] rounded-xl p-4 sm:p-5 hover:border-violet-500/25 transition-all duration-300"
              >
          ...
          >
            ...
            <a
              ...
              className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-white/[0.04] border border-violet-500/20 text-gray-300 hover:text-white hover:bg-violet-500/10 hover:border-violet-500/40 transition-all duration-500 text-sm sm:text-base font-medium backdrop-blur-sm"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
              </svg>
