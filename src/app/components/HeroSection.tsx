  ...
  return (
    <section className="relative min-h-screen flex items-center py-20 px-4 sm:px-6 md:px-12 lg:px-24 bg-[#0a0a0f] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-purple-600/20 rounded-full blur-[180px]" />
        <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-fuchsia-600/15 rounded-full blur-[180px]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-violet-500/10 rounded-full blur-[140px]" />
      </div>
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center max-w-7xl mx-auto w-full">
        ...
        >
          {/* Status badge */}
          <motion.div
            className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-purple-500/[0.07] border border-purple-500/20 mb-6 sm:mb-8 backdrop-blur-sm"
          ...
          <div className="h-10 sm:h-12 mb-5 sm:mb-6 flex items-center justify-center lg:justify-start">
            ...
            <TypeAnimation
              ...
              speed={40}
              repeat={Infinity}
              className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-fuchsia-400 to-violet-400 font-bold"
            />
          </div>
          ...
          <p className="text-gray-400 text-sm sm:text-base md:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0 mb-8 sm:mb-10">
            Building{" "}
            <span className="text-fuchsia-400 font-semibold">intelligent AI systems</span>{" "}
            that work for you. Focused on{" "}
            <span className="text-purple-400 font-semibold">agentic AI</span>, automation, and
          ...
          >
            <Link
              href="/#contact"
              className="group relative w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-gradient-to-r from-purple-600 via-fuchsia-500 to-violet-500 text-white hover:from-purple-500 hover:via-fuchsia-400 hover:to-violet-400 transition-all duration-500 text-sm sm:text-base font-semibold shadow-xl shadow-purple-500/30 hover:shadow-fuchsia-500/40 overflow-hidden"
            >
              <span className="relative z-10 flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg>
                Let&apos;s Talk
              </span>
              <div className="absolute inset-0 bg-gradient-to-r from-fuchsia-500 to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            </Link>

            <Link
              href="/#project"
              className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-white/[0.04] border border-purple-500/20 text-gray-300 hover:text-white hover:bg-purple-500/10 hover:border-purple-500/40 transition-all duration-500 text-sm sm:text-base font-medium backdrop-blur-sm"
            >
          ...
          >
            <a href="https://x.com/FatimahBuildsAI" target="_blank" rel="noopener noreferrer"
              className="group w-10 h-10 rounded-xl bg-white/[0.04] border border-purple-500/15 flex items-center justify-center hover:bg-purple-500/15 hover:border-purple-500/40 transition-all duration-300">
            ...
            <a href="https://github.com/Fatimahnoman" target="_blank" rel="noopener noreferrer"
              className="group w-10 h-10 rounded-xl bg-white/[0.04] border border-purple-500/15 flex items-center justify-center hover:bg-fuchsia-500/15 hover:border-fuchsia-500/40 transition-all duration-300">
            ...
            <a href="https://www.facebook.com/share/1Bx8NV5RLU/" target="_blank" rel="noopener noreferrer"
              className="group w-10 h-10 rounded-xl bg-white/[0.04] border border-purple-500/15 flex items-center justify-center hover:bg-violet-500/15 hover:border-violet-500/40 transition-all duration-300">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-gray-500 group-hover:text-violet-400 transition-colors">
            ...
            <a href="https://www.instagram.com/fatimah_builds_ai?utm_source=qr&igsh=MTFrYzdka3U0djF5Nw==" target="_blank" rel="noopener noreferrer"
              className="group w-10 h-10 rounded-xl bg-white/[0.04] border border-purple-500/15 flex items-center justify-center hover:bg-pink-500/15 hover:border-pink-500/40 transition-all duration-300">
        ...
        >
          <div className="relative">
            {/* Outer glow ring */}
            <div className="absolute -inset-6 bg-gradient-to-r from-purple-500/25 via-fuchsia-500/15 to-violet-500/25 rounded-full blur-3xl animate-pulse" style={{ animationDuration: "4s" }} />

            {/* Rotating border */}
            <motion.div
              className="absolute -inset-3 rounded-full"
              style={{
                background: "conic-gradient(from 0deg, transparent, #a855f7, transparent, #d946ef, transparent, #8b5cf6, transparent)",
              }}
              animate={{ rotate: 360 }}
            ...
            <motion.div
              ...
              style={{
                background: "conic-gradient(from 180deg, transparent, #d946ef, transparent, #a855f7, transparent)",
              }}
              animate={{ rotate: -360 }}
            ...
            <motion.div
              className="absolute -right-2 top-1/4 px-3 py-1.5 rounded-lg bg-[#12121a] border border-purple-500/25 text-xs font-mono text-purple-400 shadow-lg shadow-purple-500/10"
              animate={{ y: [0, -8, 0] }}
            ...
            <motion.div
              className="absolute -left-2 top-1/2 px-3 py-1.5 rounded-lg bg-[#12121a] border border-fuchsia-500/25 text-xs font-mono text-fuchsia-400 shadow-lg shadow-fuchsia-500/10"
              animate={{ y: [0, 8, 0] }}
            ...
            <motion.div
              className="absolute -right-2 bottom-1/4 px-3 py-1.5 rounded-lg bg-[#12121a] border border-violet-500/25 text-xs font-mono text-violet-400 shadow-lg shadow-violet-500/10"
              animate={{ y: [0, -6, 0] }}
