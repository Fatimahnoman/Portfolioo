  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        {/* Gradient orbs */}
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-purple-500/8 rounded-full blur-[120px]" />
        <div className="absolute top-1/2 -left-40 w-80 h-80 bg-violet-500/6 rounded-full blur-[120px]" />
        <div className="absolute bottom-0 right-1/4 w-60 h-60 bg-purple-500/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {featuredProject && (
          ...
          >
            <div className="relative group rounded-2xl overflow-hidden bg-[#111118] border border-white/[0.06] hover:border-purple-500/25 transition-all duration-500 shadow-2xl shadow-black/30 hover:shadow-purple-500/5">
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-0">
                ...
                <div className="relative lg:col-span-3 h-64 sm:h-72 md:h-80 lg:h-auto min-h-[280px] overflow-hidden bg-[#0a0a12] flex items-center justify-center p-4 sm:p-6">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-500/8 via-transparent to-violet-500/8 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />

                  {/* Featured badge */}
                  <div className="absolute top-5 left-5 flex items-center gap-2">
                    <div className="px-4 py-2 rounded-xl bg-gradient-to-r from-purple-600 to-violet-500 text-white text-xs font-bold shadow-xl shadow-purple-500/25">
                      ⭐ Featured
                    </div>
                  </div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-all duration-500">
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="flex items-center gap-2 px-5 py-3 rounded-xl bg-black/60 backdrop-blur-xl border border-white/15 text-white text-sm font-medium hover:bg-purple-500/30 hover:border-purple-500/50 transition-all duration-300 shadow-xl shadow-black/40"
                    >
                    ...
                    {featuredProject.previewUrl !== "terminal-mockup" && featuredProject.previewUrl !== "wellness-terminal" ? (
                      <motion.a
                        ...
                        whileHover={{ scale: 1.05, y: -2 }}
                        whileTap={{ scale: 0.95 }}
                        className="flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-violet-500 text-white text-sm font-semibold shadow-xl shadow-purple-500/25 hover:from-violet-500 hover:to-purple-600 transition-all duration-300"
                      >
                      ...
                      <motion.button
                        ...
                        whileHover={{ scale: 1.05, y: -2 }}
                        whileTap={{ scale: 0.95 }}
                        className="flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-violet-500 text-white text-sm font-semibold shadow-xl shadow-purple-500/25 hover:from-violet-500 hover:to-purple-600 transition-all duration-300 cursor-pointer"
                      >
                ...
                <div className="lg:col-span-2 p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
                  <span className="text-[11px] text-purple-400 font-mono mb-3 tracking-wider">FEATURED PROJECT</span>

                  <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-3 leading-snug group-hover:text-purple-300 transition-colors duration-300">
                    ...
                    {featuredProject.techStack.map((tech, i) => (
                      <span
                        ...
                        className={`px-3 py-1.5 text-xs font-medium rounded-lg border ${
                          i % 2 === 0
                            ? "bg-purple-500/8 text-purple-300/90 border-purple-500/15"
                  ...
                  <div className="flex flex-wrap gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/[0.04] border border-white/[0.08] text-gray-300 text-sm font-medium hover:bg-purple-500/10 hover:border-purple-500/30 hover:text-purple-300 transition-all duration-300"
                    >
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.387.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.416-4.042-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.09-.745.084-.73.084-.73 1.205.084 1.84 1.236 1.84 1.236 1.07 1.835 2.807 1.305 3.492.998.108-.775.418-1.305.76-1.605-2.665-.303-5.466-1.332-5.466-5.93 0-1.31.468-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.435.372.81 1.102.81 2.222 0 1.606-.015 2.896-.015 3.286 0 .315.21.693.825.576C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" /></svg>
                      Source Code
                    </a>
                    {featuredProject.previewUrl !== "terminal-mockup" && featuredProject.previewUrl !== "wellness-terminal" ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-violet-500 text-white text-sm font-semibold hover:from-violet-500 hover:to-purple-600 transition-all duration-300 shadow-lg shadow-purple-500/15"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" /></svg>
                        Live Demo
                      </a>
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-violet-500 text-white text-sm font-semibold hover:from-violet-500 hover:to-purple-600 transition-all duration-300 shadow-lg shadow-purple-500/15 cursor-pointer"
                      >
                        Open Terminal
                      </button>
                    )}
            ...
            return (
              <motion.button
                ...
                className={`relative flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 ${
                  isActive
                    ? "text-white bg-gradient-to-r from-purple-600 to-violet-500 shadow-lg shadow-purple-500/20"
        ...
        {filteredProjects.length > INITIAL_COUNT && (
          ...
          >
            <motion.button
              ...
              className="group relative px-8 py-3.5 rounded-xl bg-white/[0.03] border border-white/[0.08] text-gray-300 font-medium text-sm hover:text-white hover:border-purple-500/40 transition-all duration-300 flex items-center gap-3 overflow-hidden"
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.96 }}
            >
              ...
              <span className="relative z-10 flex items-center gap-3">
                {hasMore ? (
                  <>
                    Show More
                    <span className="text-purple-400/80 text-xs">({filteredProjects.length - visibleCount} remaining)</span>
