  ...
  return (
    <section className="relative bg-[#070512] py-20 sm:py-24 px-4 sm:px-6 md:px-12 lg:px-24 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-fuchsia-500/[0.03] rounded-full blur-[150px]" />
      </div>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <SectionHeader
          ...
          titleA="Hackathon"
          titleB="Highlights"
          subtitle="Real projects, real deadlines, real results."
        />
        ...
        <div className="relative min-h-[320px] sm:min-h-[300px]">
          <AnimatePresence mode="wait">
            ...
            >
              <SpotlightCard className="relative bg-[#120e20] border border-white/[0.06] rounded-2xl p-7 sm:p-9 md:p-10 text-center hover:border-white/[0.1] transition-all duration-500 overflow-hidden">
              {/* Top accent */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-[2px] bg-gradient-to-r from-transparent via-violet-500/40 to-transparent" />
              ...
              {/* Achievement badge */}
              <div className="mb-4">
                <span className="px-3 py-1 rounded-lg bg-violet-500/15 text-violet-400 text-xs font-bold border border-violet-500/20 uppercase tracking-wider">
              ...
              <p className="text-violet-400/70 text-sm font-medium mb-4">{highlights[current].role}</p>
          ...
          {highlights.map((_, index) => (
            <button
              ...
              className={`h-2 rounded-full transition-all duration-500 ${
                index === current
                  ? "bg-gradient-to-r from-violet-500 via-violet-500 to-fuchsia-500 w-7"
