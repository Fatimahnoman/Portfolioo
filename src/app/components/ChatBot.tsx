...
const knowledge: { keywords: string[]; responses: string[] }[] = [
  {
    keywords: ["who", "about", "tell me about", "introduce", "yourself", "profile"],
    responses: [
  ...
  {
    keywords: ["skill", "technologies", "tech stack", "what can", "what do you know", "tools", "languages"],
    responses: [
  ...
  {
    keywords: ["project", "portfolio", "work", "built", "created", "applications"],
    responses: [
      ...
      "She's got quite a collection! The highlights include autonomous AI agents (StudiesHelper, WellnessOracle), e-commerce platforms (Blushhaven Shop), educational tools (AI Mini Textbook), and several hackathon projects. What's really impressive is that she handles the full stack — from AI logic to deployment on Vercel.",
    ],
  },
  {
    keywords: ["ai", "artificial intelligence", "machine learning", "agent", "agentic", "openai"],
    responses: [
      "This is where Fatimah really shines! She's built multi-agent systems using OpenAI's Agents SDK — we're talking autonomous agents that can reason, use tools, and collaborate. She understands RAG pipelines, vector search, tool design, guardrails, and streaming. Her AI projects aren't just demos — they solve real problems like helping students study and managing wellness.",
  ...
  {
    keywords: ["web", "full stack", "fullstack", "frontend", "backend", "next", "react", "website"],
    responses: [
 ...
 {
    keywords: ["education", "study", "degree", "university", "college", "bba", "qualification"],
    responses: [
  ...
  {
    keywords: ["experience", "work", "job", "hire", "available", "freelance", "employ", "join"],
    responses: [
  ...
  {
    keywords: ["contact", "email", "reach", "connect", "phone", "location", "where"],
    responses: [
  ...
  {
    keywords: ["hackathon", "competition", "event", "hack"],
    responses: [
      ...
      "She's competed in multiple hackathons and loved every minute of it! Hackathons are where she gets to combine her AI knowledge with full-stack development under time pressure. She's got 3+ hackathon experiences under her belt.",
    ],
  },
  {
    ...
    responses: [
      ...
      "Fatimah is a Python expert — we're talking advanced OOP, data structures, async patterns, and clean architecture. She started her coding journey with Python and it's still her go-to language for AI and backend development.",
    ],
  },
  {
    keywords: ["docker", "deploy", "vercel", "devops", "ci", "cloud"],
    responses: [
      ...
      "On the deployment side, Fatimah works with Docker for containerization, Vercel for hosting (including this portfolio!), and CI/CD pipelines for automated deployments. She understands how to build scalable, cloud-native architectures.",
    ],
  },
  {
    keywords: ["hello", "hi", "hey", "greetings", "sup", "how are you"],
    responses: [
  ...
  {
    keywords: ["name", "what's your name", "who are you"],
    responses: [
  ...
  {
    keywords: ["design", "ui", "ux", "figma", "css", "style"],
    responses: [
      ...
      "On the design front, Fatimah uses Tailwind CSS and Framer Motion to create beautiful, responsive interfaces. She pays attention to UX details and believes that functionality and aesthetics go hand in hand.",
    ],
  },
  {
    keywords: ["database", "sql", "postgresql", "mongo", "data"],
    responses: [
      ...
      "She's worked with PostgreSQL and understands database design. Combined with her Python skills (including Pandas for data analysis), she can handle the full data pipeline.",
    ],
  },
];

const fallbackResponses = [
  "That's an interesting question! While I know a lot about Fatimah's skills and projects, I might not have the perfect answer for that. Try asking about her skills, projects, education, or how to contact her!",
  "Hmm, I'm not sure I have the best answer for that. But I can tell you all about Fatimah's Python expertise, AI projects, web development skills, or how to get in touch with her!",
  "Great question, but that's a bit outside my knowledge! I'm best at answering questions about Fatimah's work — like her AI agents, web projects, or technical skills.",
  "I'd love to help with that, but I'm more of a Fatimah-expert than a general assistant! Try asking about her projects, skills, or experience.",
];
