...
const ContactSection = () => {
  ...
  const inputClasses = "w-full bg-[#111118] border border-white/[0.06] rounded-xl px-4 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-indigo-500/40 focus:bg-[#151520] transition-all duration-300 text-sm sm:text-base";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-0 w-[400px] h-[400px] bg-indigo-500/5 rounded-full blur-[150px]" />
        <div className="absolute bottom-1/4 left-0 w-[400px] h-[400px] bg-teal-500/5 rounded-full blur-[150px]" />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          >
            ...
            <div className="space-y-5">
              ...
              <motion.div className="flex items-center gap-4 group" whileHover={{ x: 6 }}>
                <div className="w-11 h-11 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
              ...
              {/* Location */}
              <motion.div className="flex items-center gap-4 group" whileHover={{ x: 6 }}>
                <div className="w-11 h-11 rounded-xl bg-teal-500/10 border border-teal-500/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
          ...
          >
            <form onSubmit={handleSubmit} className="relative bg-[#111118] border border-white/[0.06] rounded-2xl p-6 sm:p-8 space-y-5 hover:border-white/[0.1] transition-all duration-500">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-[2px] bg-gradient-to-r from-transparent via-indigo-500/30 to-transparent" />
