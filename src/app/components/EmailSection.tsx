...
const ContactSection = () => {
  ...
  const inputClasses = "w-full bg-[#120e20] border border-white/[0.06] rounded-xl px-4 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-violet-500/40 focus:bg-[#151520] transition-all duration-300 text-sm sm:text-base";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-0 w-[400px] h-[400px] bg-violet-500/5 rounded-full blur-[150px]" />
        <div className="absolute bottom-1/4 left-0 w-[400px] h-[400px] bg-fuchsia-500/5 rounded-full blur-[150px]" />
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {submitStatus === "success" && (
          <motion.div
            ...
            className="mb-8 p-5 bg-[#120e20] border border-emerald-500/20 rounded-2xl text-center max-w-xl mx-auto"
          >
        ...
        {submitStatus === "error" && (
          <motion.div
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            className="mb-8 p-5 bg-[#120e20] border border-red-500/20 rounded-2xl text-center max-w-xl mx-auto"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          >
            ...
            <div className="space-y-5">
              ...
              {/* Location */}
              <motion.div className="flex items-center gap-4 group" whileHover={{ x: 6 }}>
                <div className="w-11 h-11 rounded-xl bg-fuchsia-500/10 border border-fuchsia-500/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
            ...
            <div className="mt-8 pt-8 border-t border-white/[0.06]">
              ...
              <div className="flex gap-3">
                <motion.a href="https://x.com/FatimahBuildsAI" target="_blank" rel="noopener noreferrer" aria-label="Fatimah Noman on X (Twitter)" whileHover={{ y: -3 }} className="w-10 h-10 rounded-xl bg-[#120e20] border border-white/[0.06] flex items-center justify-center hover:border-white/[0.15] transition-all duration-300">
                ...
                <motion.a href="https://github.com/Fatimahnoman" target="_blank" rel="noopener noreferrer" aria-label="Fatimah Noman on GitHub" whileHover={{ y: -3 }} className="w-10 h-10 rounded-xl bg-[#120e20] border border-white/[0.06] flex items-center justify-center hover:border-white/[0.15] transition-all duration-300">
                ...
                <motion.a href="https://www.linkedin.com/in/fatimayy-n/" target="_blank" rel="noopener noreferrer" aria-label="Fatimah Noman on LinkedIn" whileHover={{ y: -3 }} className="w-10 h-10 rounded-xl bg-[#120e20] border border-white/[0.06] flex items-center justify-center hover:border-white/[0.15] transition-all duration-300">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-gray-400"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0z" /></svg>
                </motion.a>
                <motion.a href="https://www.facebook.com/share/1Bx8NV5RLU/" target="_blank" rel="noopener noreferrer" aria-label="Fatimah Noman on Facebook" whileHover={{ y: -3 }} className="w-10 h-10 rounded-xl bg-[#120e20] border border-white/[0.06] flex items-center justify-center hover:border-white/[0.15] transition-all duration-300">
                ...
                <motion.a href="https://www.instagram.com/fatimah_builds_ai" target="_blank" rel="noopener noreferrer" aria-label="Fatimah Noman on Instagram" whileHover={{ y: -3 }} className="w-10 h-10 rounded-xl bg-[#120e20] border border-white/[0.06] flex items-center justify-center hover:border-white/[0.15] transition-all duration-300">
          ...
          >
            <form onSubmit={handleSubmit} className="relative bg-[#120e20] border border-white/[0.06] rounded-2xl p-6 sm:p-8 space-y-5 hover:border-white/[0.1] transition-all duration-500">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-[2px] bg-gradient-to-r from-transparent via-violet-500/30 to-transparent" />

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  <label htmlFor="contact-name" className="block text-[11px] text-gray-600 uppercase tracking-wider font-mono mb-2">Name</label>
                  <input
                    id="contact-name"
                    type="text"
                    name="name"
                ...
                <div>
                  <label htmlFor="contact-email" className="block text-[11px] text-gray-600 uppercase tracking-wider font-mono mb-2">Email</label>
                  <input
                    id="contact-email"
                    type="email"
                    name="email"
              ...
              <div>
                <label htmlFor="contact-subject" className="block text-[11px] text-gray-600 uppercase tracking-wider font-mono mb-2">Subject</label>
                <input
                  id="contact-subject"
                  type="text"
                  name="subject"
              ...
              <div>
                <label htmlFor="contact-message" className="block text-[11px] text-gray-600 uppercase tracking-wider font-mono mb-2">Message</label>
                <textarea
                  id="contact-message"
                  name="message"
