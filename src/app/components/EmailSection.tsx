            ...
            <div className="pt-6 sm:pt-8 border-t border-white/10">
              ...
              <div className="flex gap-3 sm:gap-4">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center transition-all duration-300"
                >
                  <img
                ...
                >
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-md flex items-center justify-center bg-gradient-to-br from-yellow-400 via-pink-500 to-indigo-600">
                    <svg viewBox="0 0 24 24" fill="white" className="w-4 h-4 sm:w-5 sm:h-5" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.1, y: -2 }}
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:border-blue-600 transition-all duration-300"
                >
                  <img
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.1, y: -2 }}
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:border-pink-500 transition-all duration-300"
                >
                  <img
